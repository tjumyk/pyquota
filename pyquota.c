...
static PyMethodDef methodDefs[] = {
        {"userQuotaOn",           userQuotaOn,           METH_VARARGS, "Turn on user quotas for a filesystem"},
        {"userQuotaOff",          userQuotaOff,          METH_VARARGS, "Turn off user quotas for a filesystem"},
        {"getUserQuota",          getUserQuota,          METH_VARARGS, "Get quota of a user on a filesystem"},
        {"getNextUserQuota",      getNextUserQuota,      METH_VARARGS, "Get quota of the next user, whose ID is greater than or equal to the specified ID, on a filesystem"},
        {"setUserQuota",          setUserQuota,          METH_VARARGS, "Set quota of a user on a filesystem"},
        {"getUserQuotaInfo",      getUserQuotaInfo,      METH_VARARGS, "Get information about the user quotafile for a filesystem"},
        {"setUserQuotaInfo",      setUserQuotaInfo,      METH_VARARGS, "Set information about the user quotafile for a filesystem"},
        {"getUserQuotaFormat",    getUserQuotaFormat,    METH_VARARGS, "Get quota format used for user quotas on a filesystem"},
        {"syncUserQuotas",        syncUserQuotas,        METH_VARARGS, "Update the on-disk copy of user quota usages for a filesystem or all filesystems with active quotas"},

        {"groupQuotaOn",          groupQuotaOn,          METH_VARARGS, "Turn on group quotas for a filesystem"},
        {"groupQuotaOff",         groupQuotaOff,         METH_VARARGS, "Turn off group quotas for a filesystem"},
        {"getGroupQuota",         getGroupQuota,         METH_VARARGS, "Get quota of a group on a filesystem"},
        {"getNextGroupQuota",     getNextGroupQuota,     METH_VARARGS, "Get quota of the next group, whose ID is greater than or equal to the specified ID, on a filesystem"},
        {"setGroupQuota",         setGroupQuota,         METH_VARARGS, "Set quota of a group on a filesystem"},
        {"getGroupQuotaInfo",     getGroupQuotaInfo,     METH_VARARGS, "Get information about the group quotafile for a filesystem"},
        {"setGroupQuotaInfo",     setGroupQuotaInfo,     METH_VARARGS, "Set information about the group quotafile for a filesystem"},
        {"getGroupQuotaFormat",   getGroupQuotaFormat,   METH_VARARGS, "Get quota format used for group quotas on a filesystem"},
        {"syncGroupQuotas",       syncGroupQuotas,       METH_VARARGS, "Update the on-disk copy of group quota usages for a filesystem or all filesystems with active quotas"},

        {"projectQuotaOn",        projectQuotaOn,        METH_VARARGS, "Turn on project quotas for a filesystem"},
        {"projectQuotaOff",       projectQuotaOff,       METH_VARARGS, "Turn off project quotas for a filesystem"},
        {"getProjectQuota",       getProjectQuota,       METH_VARARGS, "Get quota of a project on a filesystem"},
        {"getNextProjectQuota",   getNextProjectQuota,   METH_VARARGS, "Get quota of the next project, whose ID is greater than or equal to the specified ID, on a filesystem"},
        {"setProjectQuota",       setProjectQuota,       METH_VARARGS, "Set quota of a project on a filesystem"},
        {"getProjectQuotaInfo",   getProjectQuotaInfo,   METH_VARARGS, "Get information about the project quotafile for a filesystem"},
        {"setProjectQuotaInfo",   setProjectQuotaInfo,   METH_VARARGS, "Set information about the project quotafile for a filesystem"},
        {"getProjectQuotaFormat", getProjectQuotaFormat, METH_VARARGS, "Get quota format used for project quotas on a filesystem"},
        {"syncProjectQuotas",     syncProjectQuotas,     METH_VARARGS, "Update the on-disk copy of project quota usages for a filesystem or all filesystems with active quotas"},
